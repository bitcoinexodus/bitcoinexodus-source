...
# TestP2PConn: A peer we use to send messages to bitcoinexodusd, and store responses.
...
class CompactBlocksTest(BitcoinExodusTestFramework):
    ...
    # This test actually causes bitcoinexodusd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinexodusd's choice of nonce.
    ...
    # Test that bitcoinexodusd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinexodusd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinexodusd will not send blocktxn responses for blocks whose height is
