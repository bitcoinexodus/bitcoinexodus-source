...
"""Verify that starting bitcoinexodus with -h works as expected."""

from test_framework.test_framework import BitcoinExodusTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinExodusTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinexodus with -h for help text")
        ...
        self.log.info("Start bitcoinexodus with -version for version information")
        ...
        self.log.info("Start bitcoinexodusd with -fakearg to make sure it does not start")
