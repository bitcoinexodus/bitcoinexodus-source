...
#ifndef BITCOINEXODUS_WALLET_WALLET_H
#define BITCOINEXODUS_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinexodus node, and set to 0 for transactions that were created
...
#endif // BITCOINEXODUS_WALLET_WALLET_H
