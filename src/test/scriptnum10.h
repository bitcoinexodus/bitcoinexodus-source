...
#ifndef BITCOINEXODUS_TEST_SCRIPTNUM10_H
#define BITCOINEXODUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinExodus Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINEXODUS_TEST_BIGNUM_H
