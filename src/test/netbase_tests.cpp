...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinexoduscore.org", "www.bitcoinexoduscore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinexoduscore.org]", "www.bitcoinexoduscore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinexoduscore.org:80", "www.bitcoinexoduscore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinexoduscore.org]:80", "www.bitcoinexoduscore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:21528", "127.0.0.1", 21528));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:21528", "127.0.0.1", 21528));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:21528", "::ffff:127.0.0.1", 21528));
    BOOST_CHECK(TestSplitHost("[::]:21528", "::", 21528));
    BOOST_CHECK(TestSplitHost("::21528", "::21528", -1));
    BOOST_CHECK(TestSplitHost(":21528", "", 21528));
    BOOST_CHECK(TestSplitHost("[]:21528", "", 21528));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:21528", "127.0.0.1:21528"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:21528", "[::]:21528"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
