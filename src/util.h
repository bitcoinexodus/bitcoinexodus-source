 ...
 */
#ifndef BITCOINEXODUS_UTIL_H
#define BITCOINEXODUS_UTIL_H
...
extern const char * const BITCOINEXODUS_CONF_FILENAME;
extern const char * const BITCOINEXODUS_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinexodus-%s", name);
