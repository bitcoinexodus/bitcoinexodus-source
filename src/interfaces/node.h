...
#ifndef BITCOINEXODUS_INTERFACES_NODE_H
#define BITCOINEXODUS_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinexodus node (bitcoinexodusd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINEXODUS_INTERFACES_NODE_H
