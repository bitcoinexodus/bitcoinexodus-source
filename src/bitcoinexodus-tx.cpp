...
static void SetupBitcoinExodusTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinexodus-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinexodus-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinexodus transaction\n" +
            "or:     bitcoinexodus-tx [options] -create [commands]   Create hex-encoded bitcoinexodus transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinexodus transaction
