...
#ifndef BITCOINEXODUS_QT_SENDCOINSDIALOG_H
#define BITCOINEXODUS_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinexoduss */
...
#endif // BITCOINEXODUS_QT_SENDCOINSDIALOG_H
