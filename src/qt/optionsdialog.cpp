    ...
    mapper(0)
{
    ...
    ui->bitcoinexodusAtStartup->setToolTip(ui->bitcoinexodusAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinexodusAtStartup->setText(ui->bitcoinexodusAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinExodusConfButton->setToolTip(ui->openBitcoinExodusConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinExodusUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinexodusAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinExodusConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinExodusConf())
