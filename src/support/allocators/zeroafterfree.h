...
#ifndef BITCOINEXODUS_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINEXODUS_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINEXODUS_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
