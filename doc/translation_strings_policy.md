...
This document provides guidelines for internationalization of the BitcoinExodus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinexodus_en.ts` remains unchanged.
